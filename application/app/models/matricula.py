...
def buscar_aluno_por_ra(ra_aluno):
    ...
    busca_aluno = "SELECT id_matricula FROM tb_matriculas WHERE ra_aluno = %s"
...
def validar_matricula(ra_aluno, id_turma):
    ...
    busca_matricula = "SELECT id_matricula FROM tb_matriculas WHERE ra_aluno = %s AND id_turma = %s"
